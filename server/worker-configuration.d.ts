/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: df54cb39f07fc008f7e323cd43d4a72f)
...
declare namespace Cloudflare {
	...
	interface Env {
		PRODUCTION_WEB_URL: "https://aiss-nepch-web-dev-8fi.pages.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRODUCTION_WEB_URL" | "GOOGLE_GENERATIVE_AI_API_KEY" | "GOOGLE_SEARCH_ENGINE_ID" | "WEBAUTHN_RP_ID" | "WEBAUTHN_RP_NAME" | "WEBAUTHN_ORIGIN">> {}
}
