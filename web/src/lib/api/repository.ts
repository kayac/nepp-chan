...
import { createTagGroupRepository } from "@nepp-chan/shared/api/repository/tag-group-repository";
...
export const tagGroupRepository = createTagGroupRepository(client);
